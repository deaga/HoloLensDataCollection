...
{
    class HoloLensDataCollectionMain : public DX::IDeviceNotify
    {
    public:
        HoloLensDataCollectionMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~HoloLensDataCollectionMain();
    ...
    private:
		...
		LocatableCamera mLocatableCamera;
    };
}
